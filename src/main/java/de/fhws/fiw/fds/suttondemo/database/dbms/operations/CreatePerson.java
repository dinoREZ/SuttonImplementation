...
import de.fhws.fiw.fds.suttondemo.database.dbms.tables.SetParametersInSqlStatement;
...
public class CreatePerson extends AbstractSaveOperation<Person>
{
	...
	@Override protected List<String> columnNames( )
	{
		return PersonTable.ALL_COLUMNS;
	}

	@Override protected void setValuesToPreparedStatement( ) throws SQLException
	{
