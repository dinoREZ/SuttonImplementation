...
public class CoursesOfStudentsDaoHibernateImpl implements CoursesOfStudentsDaoHibernate {
    ...
    @Override
    public CollectionModelHibernateResult<CourseDB> readByQuery(long primaryId, String name, Integer roomNumber, SearchParameter searchParameter) {
        return new CoursesOfStudentByQueryOperation(emf, primaryId, name, roomNumber, searchParameter).start();
    }
