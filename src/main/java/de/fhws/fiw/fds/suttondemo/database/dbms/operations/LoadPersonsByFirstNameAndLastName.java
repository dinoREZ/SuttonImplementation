...
public class LoadPersonsByFirstNameAndLastName extends AbstractLoadCollectionOperation<FirstAndLastName, Person>
{
	...
	@Override protected String createSQLStatementWithoutSelectStartingAfterFrom( )
	{
		 ...
		 * It takes into account that either first name or last name or both can be empty
		 * strings. First, it is checked whether the query parameter is empty OR (if not)
