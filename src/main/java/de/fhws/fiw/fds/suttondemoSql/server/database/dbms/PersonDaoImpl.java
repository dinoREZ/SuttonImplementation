package de.fhws.fiw.fds.suttondemoSql.server.database.dbms;

import de.fhws.fiw.fds.sutton.server.database.SearchParameter;
import de.fhws.fiw.fds.sutton.server.database.results.CollectionModelResult;
import de.fhws.fiw.fds.sutton.server.database.results.NoContentResult;
import de.fhws.fiw.fds.sutton.server.database.results.SingleModelResult;
import de.fhws.fiw.fds.suttondemoSql.server.database.PersonDao;
import de.fhws.fiw.fds.suttondemoSql.server.database.dbms.operations.CreatePerson;
import de.fhws.fiw.fds.suttondemoSql.server.database.dbms.operations.DeleteAll;
import de.fhws.fiw.fds.suttondemoSql.server.database.dbms.operations.DeletePerson;
import de.fhws.fiw.fds.suttondemoSql.server.database.dbms.operations.FirstAndLastName;
import de.fhws.fiw.fds.suttondemoSql.server.database.dbms.operations.LoadAllPersons;
import de.fhws.fiw.fds.suttondemoSql.server.database.dbms.operations.LoadPersonById;
import de.fhws.fiw.fds.suttondemoSql.server.database.dbms.operations.LoadPersonsByFirstNameAndLastName;
import de.fhws.fiw.fds.suttondemoSql.server.database.dbms.operations.UpdatePerson;
